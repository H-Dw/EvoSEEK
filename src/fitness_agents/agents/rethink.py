...
from .output_contracts import HypothesisReflectionOutput, ReThinkDimensionGroupOutput
...
class MockReThinkClient:
    ...
    def __init__(self) -> None:
        self.last_dimension_groups: tuple[ReThinkDimensionGroupOutput, ...] = ()
    ...
    def _reflect_dimension_group(
        ...
        *,
        ...
        def validate_output(value: dict[str, Any]) -> dict[str, Any]:
            ...
            output = ReThinkDimensionGroupOutput.model_validate(decoded)
            ...
            messages=[
                {
                    ...
                    "content": (
                        ...
                        "ReThinkDimensionGroupOutput JSON without hidden reasoning. Required "
                        "dimensions: "
                        + json.dumps(dimensions)
                        + ". Schema: "
                        + json.dumps(
                            ReThinkDimensionGroupOutput.model_json_schema(), ensure_ascii=False
                        )
                    ),
                },
                {
