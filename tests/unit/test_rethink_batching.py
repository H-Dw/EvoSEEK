...
from fitness_agents.agents.output_contracts import HypothesisDimensionGroupOutput
...
def _group(group_name: str, dimensions: tuple[str, str]) -> HypothesisDimensionGroupOutput:
    return HypothesisDimensionGroupOutput.model_validate(
        {
            "hypothesis_id": "H01",
            "assessment_id": "HA01",
...
def test_mock_rethink_returns_one_hypothesis_reflection() -> None:
    reflection = MockHypothesisReThinkClient().reflect_hypothesis(context=_context(20))
